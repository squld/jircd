...
public class IRCDaemon implements jIRCdMBean {
	...
	public synchronized void reloadPlugins() {
		...
		// @formatter:off
		java.util.List<Class<? extends Command>> aClasses = Arrays.asList(
				jircd.irc.commands.Admin.class,
				jircd.irc.commands.Away.class,
				jircd.irc.commands.Connect.class,
				jircd.irc.commands.Die.class,
				jircd.irc.commands.Info.class,
				jircd.irc.commands.Invite.class,
				jircd.irc.commands.IsOn.class,
				jircd.irc.commands.Kick.class,
				jircd.irc.commands.Kill.class,
				jircd.irc.commands.LUsers.class,
				jircd.irc.commands.Links.class,
				jircd.irc.commands.Mode.class,
				jircd.irc.commands.Motd.class,
				jircd.irc.commands.NJoin.class,
				jircd.irc.commands.Names.class,
				jircd.irc.commands.Nick.class,
				jircd.irc.commands.Notice.class,
				jircd.irc.commands.Oper.class,
				jircd.irc.commands.Part.class,
				jircd.irc.commands.Pass.class,
				jircd.irc.commands.Ping.class,
				jircd.irc.commands.Pong.class,
				jircd.irc.commands.Quit.class,
				jircd.irc.commands.Rehash.class,
				jircd.irc.commands.Restart.class,
				jircd.irc.commands.SQuit.class,
				jircd.irc.commands.ServerCommand.class,
				jircd.irc.commands.Stats.class,
				jircd.irc.commands.Time.class,
				jircd.irc.commands.Topic.class,
				jircd.irc.commands.UserHost.class,
				jircd.irc.commands.Version.class,
				jircd.irc.commands.Wallops.class,
				jircd.irc.commands.Who.class,
				jp.kurusugawa.jircd.commands.Join.class,
				jp.kurusugawa.jircd.commands.PrivMsg.class,
				jp.kurusugawa.jircd.commands.WhoIs.class,
